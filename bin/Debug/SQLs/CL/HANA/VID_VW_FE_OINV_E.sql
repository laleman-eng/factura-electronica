...
CREATE VIEW VID_VW_FE_OINV_E
AS
	SELECT
		 T0."FolioNum"																														"FolioNum"
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' THEN '55555555-5'
		...
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
		 ...
		 END																																"DocTotal"
		,ROUND(CASE WHEN T0."DocSubType" IN ('IE', 'EB', 'IX') OR RIGHT(N1."BeginStr", 3) =  '111' OR RIGHT(N1."BeginStr", 3) = '110' THEN 0.0
		...
		,CASE WHEN T0."DocSubType" IN ('IE', 'EB', 'IX') OR RIGHT(N1."BeginStr", 3) =  '111' OR RIGHT(N1."BeginStr", 3) = '110' THEN 0.0
																						 ELSE ROUND(T0."DocTotal" - T0."VatSum", 0)

		 END																																"Total_Afecto"
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
																	THEN TO_VARCHAR(ROUND(IFNULL((SELECT SUM(CASE WHEN OINV."CurSource" = 'L' THEN "BaseSum"
		...
		,CASE WHEN T0."VatSum" > 0.0 THEN CASE WHEN T0."VatPercent" <> 0.0 THEN T0."VatPercent" 
		                                     ELSE (SELECT "Rate" FROM "OSTC" WHERE "Code" = 'IVA') END
		      ELSE 0.0
		 END																																"VatPercent"
		...
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110'
										THEN TO_VARCHAR(IFNULL(T0."U_CodModVenta", '0'))  ELSE '0' END										"CodModVenta"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodClauVenta", '0'))  ELSE '0' END										"CodClauVenta"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110'
										THEN IFNULL(T0."U_TotClauVenta", 0.0)	  ELSE 0.0 END												"TotClauVenta"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodViaTransp", '0'))  ELSE '0' END										"CodViaTransp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_NombreTransp", '')	  ELSE '' END												"NombreTransp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_RUTCiaTransp", '')	  ELSE '' END												"RUTCiaTransp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_NomCiaTransp", '')	  ELSE '' END												"NomCiaTransp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_IdAdicTransp", '')	  ELSE '' END												"IdAdicTransp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_Booking", '')		  ELSE '' END													"Booking"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_Operador", '')		  ELSE '' END												"Operador"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodPtoEmbarque", '0')) ELSE '0' END										"CodPtoEmbarque"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_IdAdicPtoEmb", '')	  ELSE '' END												"IdAdicPtoEmb"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodPtoDesemb", '0'))  ELSE '0' END										"CodPtoDesemb"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_IdAdicPtoDesemb", '') ELSE '' END													"IdAdicPtoDesemb"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_Tara", 0)			  ELSE 0 END													"Tara"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodUnidMedTara", 0))  ELSE '0' END										"CodUnidMedTara"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_PesoBruto", 0)		  ELSE 0 END												"PesoBruto"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodUnidPesoBr", '0'))   ELSE '0' END									"CodUnidPesoBruto"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_PesoNeto", 0)		  ELSE 0 END													"PesoNeto"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_VARCHAR(IFNULL(T0."U_CodUnidPesNet", '0'))   ELSE '0' END									"CodUnidPesoNeto"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN IFNULL(T0."U_TotItems", 0)		  ELSE 0 END													"TotItems"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
										THEN TO_INT(IFNULL(T0."U_TotBultos", '0')) ELSE 0 END												"TotBultos"
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110'
        ...
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN IFNULL((SELECT GA0."LineTotal"
                                                            FROM "INV3" GA0
		...
		,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN IFNULL(T0."U_CodPaisRecep", '')	  ELSE '' END											"CodPaisRecep"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN IFNULL(T0."U_CodPaisDestin", '')	  ELSE '' END											"CodPaisDestin"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN IFNULL(T0."U_TipoMoneda", '')	  ELSE '' END												"TipoMoneda"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN TO_VARCHAR(IFNULL(T0."U_FmaPagExp", 0))		  ELSE '0' END								"FmaPagExp"
        ,CASE WHEN T0."DocSubType" = 'IX' OR RIGHT(N1."BeginStr", 3) = '111' OR RIGHT(N1."BeginStr", 3) = '110' 
											THEN IFNULL(T0."U_TipoBultos", 0)		  ELSE 0 END											"TipoBultos"
