                ...
                if (! pVal.BeforeAction)
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "VID_FEMonDTE": //monitor de DTE
                            {
                                var newForm = new TMonitorDTE();
                                oForm = (IvkFormInterface)newForm;
                                newForm.MenuLlamado = "Ventas";
                                break;
                            }
                        case "VID_FEMonDTEC": //monitor de DTE Compras
                            {
                                var newForm = new TMonitorDTE();
                                oForm = (IvkFormInterface)newForm;
                                newForm.MenuLlamado = "Compras";
                                break;
                            }
                        case "VID_FEEnvDTE":
                            {
