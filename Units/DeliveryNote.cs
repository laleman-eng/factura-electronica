                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //Cargar PDF
                                            var sPDF = Reg.PDFenString(TipoDocElecAddon, (bTransferencia ? oTransfer.DocEntry.ToString() : oDocument.DocEntry.ToString()), ObjType, "", jFolio, RunningUnderSQLServer, "CL");
