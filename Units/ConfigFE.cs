...
namespace Factura_Electronica_VK.ConfigFE
{
    public class TConfigFE : TvkBaseForm, IvkFormInterface
    {
        ...
        public new bool InitForm(string uid, string xmlPath, ref Application application, ref SAPbobsCOM.Company company, ref CSBOFunctions SBOFunctions, ref TGlobalVid _GlobalSettings)
        {
            ...
            Factura_Electronica_VK.Functions.TFunctions Param;
            ...
            try
            {
                ...
                {
                    Param = new Factura_Electronica_VK.Functions.TFunctions();
                    Param.SBO_f = FSBOf;
            ...
            finally
            {
                ...
                oForm.PaneLevel = 2;
                oForm.PaneLevel = 1; // Cambio de Panel para que se muestren actualizados los controles del pane 1
                oForm.Visible = true;
