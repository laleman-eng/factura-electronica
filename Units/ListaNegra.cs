...
namespace Factura_Electronica_VK.ListaNegra
{
    public class TListaNegra : TvkBaseForm, IvkFormInterface
    {
                ...
                if ((pVal.EventType == BoEventTypes.et_CHOOSE_FROM_LIST) && (!pVal.BeforeAction))
                {
                    ...
                    if (pVal.ColUID == "U_CardCode")
                    {
                        ...
                        if (oDataTable != null)
                        {
                            ...
                            sValue3 = ((System.String)oDataTable.GetValue("CardName", 0)).Trim();
                            ...
                            odt.SetValue("LicTradNum", pVal.Row, sValue3);
        ...
        private void CargarGrid()
        {
            try
            {
                ...
                odt = ogrid.DataTable;
                if (GlobalSettings.RunningUnderSQLServer)
                    s = @"SELECT T0.DocEntry, T0.U_CardCode ,T0.U_CardName, T1.LicTradNum, T0.U_Activado FROM [@VID_FELISTANE] T0 JOIN OCRD T1 ON T0.U_CardCode = T1.CardCode";
                else
                    s = @"SELECT T0.""DocEntry"", T0.""U_CardCode"", T0.""U_CardName"", T1.""LicTradNum"", T0.""U_Activado"" FROM ""@VID_FELISTANE"" T0 JOIN ""OCRD"" T1 ON T0.""U_CardCode"" = T1.""CardCode"" ";
                ...
                ogrid.Columns.Item("LicTradNum").Type = BoGridColumnType.gct_EditText;
                oColumn = ((GridColumn)ogrid.Columns.Item("LicTradNum"));
                ((EditTextColumn)oColumn).Editable = false;
                ((EditTextColumn)oColumn).TitleObject.Caption = "RUT";
                ((EditTextColumn)oColumn).Visible = true;
