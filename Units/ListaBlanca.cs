    ...
    public class TListaBlanca: TvkBaseForm, IvkFormInterface
    {
                ...
                if ((pVal.EventType == BoEventTypes.et_CHOOSE_FROM_LIST) && (!pVal.BeforeAction))
                {
                    ...
                    if (pVal.ColUID == "U_CardCode")
                    {
                        ...
                        if (oDataTable != null)
                        {
                            ...
                            sValue3 = ((System.String)oDataTable.GetValue("LicTradNum", 0)).Trim();
        ...
        private void CargarGrid()
        {
            try
            {
                ...
                odt = ogrid.DataTable;
                if (GlobalSettings.RunningUnderSQLServer)
                    s = @"SELECT T0.DocEntry, T0.U_CardCode ,T0.U_CardName, T1.LicTradNum, T0.U_Activado FROM [@VID_FELISTABL] T0 JOIN OCRD T1 ON T0.U_CardCode = T1.CardCode";
                else
                    s = @"SELECT T0.""DocEntry"", T0.""U_CardCode"", T0.""U_CardName"", T1.""LicTradNum"", T0.""U_Activado"" FROM ""@VID_FELISTABL"" T0 JOIN ""OCRD"" T1 ON T0.""U_CardCode"" = T1.""CardCode"" ";
