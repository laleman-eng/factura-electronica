    ...
    public class TFoliarDocumento : TvkBaseForm, IvkFormInterface
    {
        ...
        public new bool InitForm(string uid, string xmlPath, ref Application application, ref SAPbobsCOM.Company company, ref CSBOFunctions SBOFunctions, ref TGlobalVid _GlobalSettings)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    oComboBox.ValidValues.Add("52S", "Guia Despacho por Solicitud Traslado");
        ...
        private void BuscarDoc(String TipoDoc, String sDesde, String sHasta)
        {
            ...
            try
            {
                ...
                else if (TipoDoc == "52S") //guia despacho por solicitud transferencia stock
                {
                    tabla = "OWTQ";
                    tablaDetalle = "WTQ1";
                    sDocSubType = "--";
